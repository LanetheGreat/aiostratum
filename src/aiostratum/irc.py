...
from .exceptions import IrcClientException
...
def get_connection():
    ...
    raise IrcClientException('IRC not connected')
...
class IrcLurkerFactory(protocol.ClientFactory):
    ...
    def _random_string(self, N):
        return ''.join(random.choice(string.ascii_uppercase + string.digits) for __ in range(N))
