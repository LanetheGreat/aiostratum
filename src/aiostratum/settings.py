...
# Remove everything below this line when copying to config.py.


def setup():
    '''
        This will import module config and move its variables into current
        module (variables in config have higher priority than this module).
        Thanks to this, you can import settings anywhere in the application
        and you'll get actual application settings.
    ...
    try:
        ...
        # Custom config not presented, so the defaults above will be preserved
        config = None
